<div class="floating-placeholder form-group floating-placeholder-float--blue floating-placeholder-float--huge">
    <label for="edit-classe-{!! $classe->name !!}" class="floating-placeholder__label">Le nom de la
...
<fieldset class="form-group-container">
    ...
    <div class="floating-placeholder form-group floating-placeholder-float--blue floating-placeholder-float--huge add_student_to_class visuallyhidden--palm">
        ...
        <label for="student_list" class="floating-placeholder__label">Sélectionnez le fichier (.CSV) contenant vos
            élèves</label>
