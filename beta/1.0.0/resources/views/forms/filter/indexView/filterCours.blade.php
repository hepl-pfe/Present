...
<div class="filter-result__item ">
    ...
    @include('errors.error_field',['field'=>'index_view_cours_list_block','name'=>'en liste/ou en block'])
</div>
<div class="filter-result__item filter-result__item--nbr-result">
    ...
    {!! Form::select('index_view_cours_nbr_pagination',config('app.defaultIndexPaginationCours'),$meta['index_view_cours_nbr_pagination'],['class'=>'mask',"data-type"=>"select",'id'=>'index_view_cours_nbr_pagination']) !!}
    @include('errors.error_field',['field'=>'index_view_cours_nbr_pagination','name'=>'nbr. de résultats'])
</div>
