...
<div class="filter-result__item filter-result__item--nbr-result">
    ...
    {!! Form::select('index_view_classe_nbr_pagination',config('app.defaultIndexPaginationClasse'),$meta['index_view_classe_nbr_pagination'],['class'=>'mask visuallyhidden',"data-type"=>"select",'id'=>'index_view_classe_nbr_pagination']) !!}
